...
export const getAllTeachers = () => async (dispatch) => {
    ...
    try {
        ...
        // Extract relevant error information and dispatch an action with serializable payload
        dispatch(getError(error.message)); // Dispatching error message instead of AxiosError object
    }
}
