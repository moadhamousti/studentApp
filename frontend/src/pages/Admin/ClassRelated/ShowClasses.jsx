...
import { deleteClass } from '../../../redux/sclassRelated/sclassSlice';
...
//     console.log(address);
//     // setMessage("Sorry the delete function has been disabled for now."); // Disable this line or remove it
//     // setShowPopup(true); // Disable this line or remove it
...
const deleteHandler = (deleteID) => {
  ...
  const actions = [
    ...
    {
      icon: <DeleteForeverIcon  style={{ color: '#bd1531' }}  />, name: 'Delete All Classes',
